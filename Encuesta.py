...
############ PÁGINA 8 #####################
elif st.session_state.paso == "S_alcance": # Evaluación de la institución.
...
elif st.session_state.paso == "D1_1":
...
#-------------------------------------------------------------------------------------
# Paso 2 - D1.2
elif st.session_state.paso == "D1_2":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#-------------------------------------------------------------------------------------
# Paso 3 - D1.3
elif st.session_state.paso == "D1_3":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#-------------------------------------------------------------------------------------
# Paso 4 - D1.4
elif st.session_state.paso == "D1_4":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
################## Paso 6 - D1.6
elif st.session_state.paso == "D1_6":
...
################## Paso 7 - D1.7
elif st.session_state.paso == "D1_7":
...
################## Paso 8 - D1.8
elif st.session_state.paso == "D1_8":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 9 - D1.9
elif st.session_state.paso == "D1_9":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 10 - D2.1
elif st.session_state.paso == "D2_1":
...
#################### Paso 11 - D2.2
elif st.session_state.paso == "D2_2":
...
#################### Paso 12 - D2.3
elif st.session_state.paso == "D2_3":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 13 - D2.4
elif st.session_state.paso == "D2_4":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 14 - D2.5
elif st.session_state.paso == "D2_5":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 15 - D2.6
elif st.session_state.paso == "D2_6":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 16 - D2.7
elif st.session_state.paso == "D2_7":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 17 - D2.8
elif st.session_state.paso == "D2_8":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 18 - D2.9
elif st.session_state.paso == "D2_9":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 19 - D2.10
elif st.session_state.paso == "D2_10":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 20 - D2.11
elif st.session_state.paso == "D2_11":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
elif st.session_state.paso == "D2_12":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 22 - D2.13
elif st.session_state.paso == "D2_13":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 23 - D2.14
elif st.session_state.paso == "D2_14":
...
#################### Paso 24 - D2.15
elif st.session_state.paso == "D2_15":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 25 - D2.16
elif st.session_state.paso == "D2_16":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 26 - D2.17
elif st.session_state.paso == "D2_17":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 27 - D2.18
elif st.session_state.paso == "D2_18":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
#################### Paso 28 - D3.1
elif st.session_state.paso == "D3_1":
...
#################### Paso 29 - D3.2
elif st.session_state.paso == "D3_2":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
...
elif st.session_state.paso == "D3_3":
    st.markdown("""
                <div style="
                background-color: #F1F3F5;
                padding: 2px 6px;
